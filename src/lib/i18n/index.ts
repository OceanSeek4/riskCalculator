...
const resources = {
  en: {
    translation: {
      ...
      stopPriceInvalid: 'Stop price must be a valid positive number',
      ...
      stopPriceOptional: 'Stop price (optional)',
      stopPriceOptionalHelp: 'Leave empty to use settings default stop mode, or enter price for price-based stop',
      currentStopMode: 'Current Stop Mode',
      usingManualPrice: 'Using manual price',
      usingSettingsDefault: 'Using settings default',
      marketOrderFeeNote: 'Market orders use Taker fees for all trades',
      marketOrderAutoTaker: 'Automatically uses All Taker fee strategy for immediate execution',
  ...
  zh: {
    translation: {
      ...
      stopPriceOptional: '止损价格（可选）',
      stopPriceOptionalHelp: '留空则使用设置中的默认止损模式，或输入价格使用价格止损',
      currentStopMode: '当前止损模式',
      usingManualPrice: '使用手动价格',
      usingSettingsDefault: '使用设置默认',
      marketOrderFeeNote: '市价单对所有交易使用Taker费率',
      marketOrderAutoTaker: '自动使用全部Taker费率策略以确保立即执行',
